					...
					<div class="modal_content">
						...
						<form class="regist" method="POST" action="<%= request.getContextPath()%>/lectureUpdate.le"  enctype="multipart/form-data">
							...
							<div class="information">
								<div class="box">
									<h2>강사</h2><br>
									<input type="text" id="lecturer" class="lecturer" name ="lecturer" placeholder="강사이름" style="width:68%;height: 30px;" value="<%=lecture.getLecturer()%>">
											<!--  <input type="text" value=" loginUser" readonly> -->
								</div>
								<br>
								<div class="box">
									<h2>강의 제목</h2><br>
									<input type="text" id="lectureTitle" class ="lectureTitle" name="lectureTitle" required style="width:68%; height: 30px;" value="<%=lecture.getLectureTitle()%>">
								</div>
								<br>
								<div class="box">
									<h2>강의 날짜</h2><br>
									<input id="lectureDate" class ="lectureDate" name ="lectureDate" type="date" required style="width:50%; height: 30px;" value="<%=lecture.getLectureDate()%>">
								</div>
								<br>
								<div class="box" style="display:inline;">
									<h2>강의 주소</h2><br>
									<input type="text" id="lectureAddress"  class ="lectureAddress" name ="lectureAddress" readonly style="width:57%; height: 30px;" value="<%=lecture.getLectureAddress()%>">
								...
								<div class="box">
									<h2>강의 인원</h2><br>
									<input type="number" id="lectureNumber"  class ="lectureNumber" name="lectureNumber" required style="width:25%; height: 30px;" value="<%=lecture.getLectureNum()%>">
								</div>
								<br>
								<div class="box">
									<h2>강의 주제</h2><br>
								...
								<div class="box">
									<h2>강의 시간</h2><br>
									<input type="number" id="lectureTime" class ="lectureTime" name ="lectureTime" placeholder="강의 인원 (분)" required style="width:25%;height: 30px;" value="<%=lecture.getLectureTime()%>">
								</div>
								<br>
								<div class="box">
									<h2>세부내용</h2><br>
									<textarea  rows="45" id="lectureContent" class ="lectureContent" name="lectureContent" style="width:100%;"><%=lecture.getLectureContent()%></textarea>
								</div>
							</div>
							<br>
