			...
			<form id="loginForm" action="<%=request.getContextPath()%>/insert.me"
				...
				<div class="name-area area">
					...
					<div id="emailCodeArea"
						...
						<input class = "inputT"
						 type="text" id="emailCode" name="emailCode" 
					...
					<div class="pwd-area area">
						<label for="userPwd" class = "labelA" >비밀번호</label> <input class = "inputT"
						 type="password"
							class="password" id="userPwd" name="userPwd" placeholder="비밀번호"
							required="required" onchange="check_pw()"> <input class = "inputT"
					...
					<div class="usercode-area">
						...
						<input type="radio" class="usercode" id="normal" name="userCode"
							value="02" checked="checked" onclick="hide();"> 
						<label class = "labelA" for="normal">일반회원</label> <input type="radio" class="usercode"
							id="business" name="userCode" value="03" onclick="show();">
						<label for="business" class = "labelA" > 사업자회원</label>
					</div>
				...
				<label class = "labelA" style="margin-bottom:0px; border-bottom:3px solid black; width:100%; margin-bottom:20px;">약관동의</label>
				<div id = agree >
				
			
				<div id="agree_all">
				  <input type="checkbox" name="agree_all" id="agree_all" class="agreeCheck">
				  <span>모든 약관에 동의합니다.</span>
				</div>
				<hr>
				<br>
				<label for="agree">
				  <input type="checkbox" name="agree" value="1" class="agreeCheck" required>
				  <span>이용약관 동의<b>(필수)</b></span>
				</label>
				<textarea class=agreeText>
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
				...
				<label for="agree">
				  <input type="checkbox" name="agree" value="2" class="agreeCheck" required>
				  <span>개인정보 수집, 이용 동의<b>(필수)</b></span>
				</label>
				<textarea class=agreeText>
				개인정보처리방침
...
2) 시행일자 : 2018년 05월 01일 
				...
				<label for="agree">
				  <input type="checkbox" name="agree" value="4" class="agreeCheck">
				  <span>이벤트, 혜택정보 수신동의<b class="select_disable">(선택)</b></span>
				</label>
