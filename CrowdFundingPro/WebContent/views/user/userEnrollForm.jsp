			...
			<form id="loginForm" action="<%=request.getContextPath()%>/insert.me"
				...
				<div class="name-area area">
					...
					<label for="name">이름</label> <input type="text" id="name"
						name="userName" placeholder="이름 입력" required="required"> <label
						for="emailId">이메일아이디</label> <input type="email" id="emailId"
					...
					<div id="emailCodeArea"
						...
						<input type="text" id="emailCode" name="emailCode"
							placeholder="인증코드 입력" required="required" autocomplete='off'>
					...
					<div class="pwd-area area">
						<label for="userPwd">비밀번호</label> <input type="password"
							class="password" id="userPwd" name="userPwd" placeholder="비밀번호"
							required="required" onchange="check_pw()"> <input
							type="password" class="password" id="userPwd2" name="userPwd2"
							placeholder="비밀번호 확인" required="required" onchange="check_pw()">
						<div id="msgBox"
							style="width: 100%; font-size: 0.8em; text-align: center;"></div>

					</div>

					<label for="userSsn">주민번호 </label> <input type="text" id="userSsn"
						name="userSsn" placeholder="주민번호 입력" required="required">
					<label for="phone">전화번호</label> <input type="tel" id="phone"
						name="phone" placeholder="전화번호 입력" required="required"> <label
						for="address">주소 </label> <input type="text" id="address"
						name="address" placeholder="주소 입력" required="required"> <label>회원구분</label>
					...
					<div class="usercode-area">
						...
						<input type="radio" class="usercode" id="normal" name="userCode"
							value="02" checked="checked" onclick="hide();"> <label
							for="normal">일반회원</label> <input type="radio" class="usercode"
							id="business" name="userCode" value="03" onclick="show();">
						<label for="business"> 사업자회원</label>
					</div>
					<div id="businessArea" style="width: 100%; display: none;">

						<label for="bNumber">사업자번호 </label> <input type="text"
